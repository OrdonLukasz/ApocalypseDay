...
public class BaseSMB<TMonoBehaviour> : SealedSMB where TMonoBehaviour : MonoBehaviour
{

    protected TMonoBehaviour context;
    ...
    {
        BaseSMB<TMonoBehaviour>[] sceneLinkedSMBs = animator.GetBehaviours<BaseSMB<TMonoBehaviour>>();
